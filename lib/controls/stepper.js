...
//   key hints  the ← → <kbd> outside the row while it is ARMED (focus inside)
...
// paddle, the latch, ← → while armed, a radio, a prose link, a deep link);
// STEP OFF = stepped → free (a governed control moved, Play, Restart, the
// latch pressed again). Stepping in from free lands on the NEAREST step.
