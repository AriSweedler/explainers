// lib/controls/stepper.js — the STEPPER: a readout of the nearest STEP plus the
// one step the last goto asked for (figure.activeState). It owns the PANEL's
// click (ENTER) and keydown (← →) listeners. The words (row, paddle, counter,
// pill, face, near, armed, caption slot, invitation, footnote, announcer) are
// defined in DESIGN.md "Stepper anatomy".
